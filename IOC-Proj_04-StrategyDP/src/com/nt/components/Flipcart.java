...
public class Flipcart {
	private CouriorServiceProvider cobj;
	...
	public void calculateBillAmount(String[] items, float[] prices) {
		...
		for(float amt : prices)
			totalAmount += amt;
		System.out.println("Bill generated rs. "+totalAmount+" for the items: "+Arrays.toString(items)+" having prices: "+Arrays.toString(prices)+"\n"+cobj.deliveryStatus(0));
	}
}
